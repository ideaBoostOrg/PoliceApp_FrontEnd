        ...
        <>
            <Row className='container'>
                {/* <Col span={10} className='header-title'> */}
                    <Breadcrumb className='page-breadcumb'>
                        <Breadcrumb.Item>
                            <a href="">Home</a>
                        </Breadcrumb.Item>
                        <Breadcrumb.Item>
                            <a href="">Clearance certificate instructions</a>
                        </Breadcrumb.Item>
                        <Breadcrumb.Item>
                            <a href="">Clearance certificate application</a>
                        </Breadcrumb.Item>
                    </Breadcrumb>
                ...
                {/* <Col span={14} style={{ padding: 50 }}> */}
                    ...
                    >
                        <Row>
                            <p>If you need to get an extended clearance certificate for a previously approved one, then please select renewal.<br/>The clearance period has to be same as the previous certificate. A new certificate for the same period but for a different country also can be obtained through the renewal. Application charges are applicable.<br />
                                An application can be renewed within one year from the date the clearance certificate was issued.</p>
                        </Row>
